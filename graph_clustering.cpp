/**
 * @file graph_clustering.cpp
 * @author Matteo Loporchio
 * @date 2025-06-20
 * 
 *  This program reads the Token Transfer Graph from a file and computes 
...
int main(int argc, char **argv) {
    ...
    igraph_transitivity_undirected(&graph, &transitivity, IGRAPH_TRANSITIVITY_NAN);
